...
for %%F in (%SRC%\osvr-ver.txt,%SRC%\bin\osvrClientKit.dll,%SRC%\bin\osvrClient.dll,%SRC%\bin\osvrTransform.dll,%SRC%\bin\osvrUtil.dll,%SRC%\bin\osvrCommon.dll) do ( xcopy %%F %DEST% /Y )
